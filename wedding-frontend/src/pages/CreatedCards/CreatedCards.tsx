    ...
    return (
        <div className="min-h-screen bg-white flex flex-col font-poppins select-none relative overflow-hidden">
            ...
            <motion.main
                ...
                className="flex-1 max-w-[90rem] mx-auto w-full px-4 md:px-8 pt-32 pb-24 space-y-12 relative z-10"
            >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                    {customerCardsData.map((item) => (
                        <motion.div
                            ...
                            className="relative aspect-[3/4.2] rounded-[2rem] overflow-hidden border border-zinc-100 shadow-[0_4px_20px_rgba(0,0,0,0.015)] hover:shadow-[0_15px_35px_rgba(244,63,94,0.08)] hover:-translate-y-1 transition-all duration-500 group cursor-pointer"
