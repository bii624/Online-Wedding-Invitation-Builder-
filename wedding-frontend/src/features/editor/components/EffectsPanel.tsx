...
const PRESETS: PresetDef[] = [
  ...
  },
  {
    ...
    label: 'Fade In All',
    icon: IconFadeInAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'fadeIn', entryDuration: 1.0, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'slideUpAll',
    label: 'Slide Up All',
    icon: IconSlideUpAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'slideInUp', entryDuration: 0.9, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'scaleInAll',
    label: 'Scale In All',
    icon: IconScaleInAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'zoomIn', entryDuration: 0.8, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'flipInAll',
    label: 'Flip In All',
    icon: IconFlipInAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'flipInX', entryDuration: 1.0, entryDelay: 1, entryEasing: 'ease' }),
  },
  {
    id: 'slideUpMix',
    label: 'Slide Up Mix',
    ...
    apply: (i) => ({
      ...
      entryDuration: 0.9, entryDelay: 1, entryEasing: 'ease-out',
    }),
  },
  {
    id: 'fadeInMix',
    ...
    apply: (i) => ({
      ...
      entryDuration: 1.0, entryDelay: 1, entryEasing: 'ease-out',
    }),
  },
  {
    id: 'bounceInAll',
    ...
    apply: (i) => ({ entryEnabled: true, entryEffect: 'bounceIn', entryDuration: 1.0, entryDelay: 1, entryEasing: 'ease' }),
  },
  {
    id: 'fadeInDownAll',
    label: 'Fade In Down All',
    icon: IconFadeInDownAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'fadeInDown', entryDuration: 1.0, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'zoomInUpAll',
    label: 'Zoom In Up All',
    icon: IconZoomInUpAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'zoomInUp', entryDuration: 0.9, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'rotateInAll',
    label: 'Rotate In All',
    icon: IconRotateInAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'rotateIn', entryDuration: 1.0, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'lightSpeedAll',
    label: 'Light Speed All',
    icon: IconLightSpeedAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'lightSpeedInRight', entryDuration: 0.8, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'backInUpAll',
    label: 'Back In Up All',
    icon: IconBackInUpAll,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'backInUp', entryDuration: 1.0, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'jackInTheBox',
    label: 'Jack In The Box',
    icon: IconJackInTheBox,
    apply: (i) => ({ entryEnabled: true, entryEffect: 'jackInTheBox', entryDuration: 1.2, entryDelay: 1, entryEasing: 'ease-out' }),
  },
  {
    id: 'slideInMix',
    label: 'Slide In Mix',
