                  ...
                  <div key={wish.id} className="bg-white border border-rose-100/60 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-rose-200 transition-all">
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider ${getSide(wish) === 'groom' ? 'bg-blue-50 text-blue-600 border border-blue-100' :
                    ...
                    <div className="flex flex-wrap gap-2.5">
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl border text-xs font-bold transition-all flex items-center gap-1.5 ${wish.isApproved
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl border text-xs font-bold transition-all ${!wish.isApproved
