...
export const AccountProfile: React.FC = () => {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      console.error(err)
      toast.error(err.response?.data?.message || 'Có lỗi xảy ra khi cập nhật mật khẩu!')
    } finally {
            ...
            {tab === 'security' && (
              <div className="max-w-md space-y-5">
                ...
                <button
                  ...
                  className="px-6 py-3 rounded-xl text-white text-xs font-bold bg-zinc-800 hover:bg-zinc-900 active:scale-95 transition-all cursor-pointer shadow-sm shadow-zinc-500/10 disabled:opacity-50"
                >
                ...
                <div className="p-4 bg-sky-50/40 rounded-2xl border border-sky-100/50 leading-relaxed">
                  ...
                  <p className="text-[11px] text-sky-600 font-medium font-inter">
