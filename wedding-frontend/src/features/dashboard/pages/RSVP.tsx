      ...
      <div className="bg-white rounded-4xl border border-rose-100/50 shadow-[0_15px_40px_rgba(244,63,94,0.015)] p-8 min-h-[75vh]">
        ...
        <div className="grid gap-5 md:grid-cols-3 mb-8">
          <div className="flex items-center gap-4 rounded-2xl border border-rose-100/40 bg-rose-50/10 p-5">
            ...
            <div>
              <p className="text-xs font-bold text-zinc-400 font-poppins uppercase tracking-wider">Số lượt phản hồi</p>
              <p className="mt-1 text-2xl font-black text-zinc-800 font-poppins">{totalRsvps}</p>
              <p className="text-[10px] text-rose-450 font-semibold font-poppins mt-0.5">Khách đã xác nhận</p>
            </div>
          </div>
          <div className="flex items-center gap-4 rounded-2xl border border-teal-100/40 bg-teal-50/10 p-5">
            ...
            <div>
              <p className="text-xs font-bold text-zinc-400 font-poppins uppercase tracking-wider">Tổng số khách tham dự</p>
              <p className="mt-1 text-2xl font-black text-zinc-800 font-poppins">{totalAttendees}</p>
              <p className="text-[10px] text-teal-600 font-semibold font-poppins mt-0.5">Xác nhận sẽ có mặt</p>
            </div>
          </div>
          <div className="flex items-center gap-4 rounded-2xl border border-pink-100/40 bg-pink-50/10 p-5">
            ...
            <div>
              <p className="text-xs font-bold text-zinc-400 font-poppins uppercase tracking-wider">Thiệp nhận phản hồi</p>
              <p className="mt-1 text-2xl font-black text-zinc-800 font-poppins">{uniqueCardsCount}</p>
                ...
                <tbody className="bg-white divide-y divide-zinc-100">
                  {rsvps.map((rsvp) => (
                    <tr key={rsvp.id} className="hover:bg-zinc-50/30 transition-colors">
                      <td className="px-6 py-4 font-bold text-zinc-800 font-poppins">
