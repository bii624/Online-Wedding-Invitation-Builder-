                ...
                <tr key={u.id}>
                  <td>
                    <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                      <div className="adm-user-avatar">{u.fullName.charAt(0)}</div>
                  ...
                  <td>
                    <div style={{ display:'flex', gap:4 }}>
                      <button className="adm-btn adm-btn-ghost adm-btn-icon" title="Xem chi tiết" onClick={() => navigate(`/admin/users/${u.id}`)}>
                        <Eye size={14} />
                      </button>
                      {u.status === 'active'
                        ? <button className="adm-btn adm-btn-danger-ghost adm-btn-icon" title="Khóa tài khoản"><Ban size={14} /></button>
                        : <button className="adm-btn adm-btn-ghost adm-btn-icon" title="Mở khóa" style={{ color:'var(--adm-success)' }}><UserCheck size={14} /></button>
                      }
                    </div>
                  </td>
                </tr>
